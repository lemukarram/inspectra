...
class DrawingProcessor:
    ...
    async def process(self, 
        ...
        Extracts location details (grid lines, levels, zones) from a 2D drawing (PDF/Image)
        ...
        Returns:
            Dict: A dictionary containing extracted 'grid_lines', 'levels', and 'zone'.
        """
        ...
        if not image_parts:
            ...
            return {"grid_lines": [], "levels": [], "zone": None}
        ...
        prompt_parts = [
            ...
            "Identify the master location details for the overall drawing based on typical construction drawing conventions.",
            ...
            "Output the results as a JSON object with keys: 'grid_lines' (list of strings), 'levels' (list of strings), and 'zone' (string). Return ONLY the JSON object.",
